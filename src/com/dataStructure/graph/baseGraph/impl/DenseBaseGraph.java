...
//稠密图：实现方式为 邻接矩阵
public class DenseBaseGraph implements IBaseGraph{
	private int vertex;//顶点
	private int edge;//边
	private boolean directed;//是否有向
	private boolean[][] graph;//图
	
	public DenseBaseGraph(int vertex,boolean directed)
	{
		this.vertex = vertex;
		this.edge = 0;
	...
	class AdjIterator{
		private DenseBaseGraph G;
		private int index;
		private int vertex;
		
		public AdjIterator(int vertex ,DenseBaseGraph G)
		{
			this.G = G;
			this.vertex = vertex;
			this.index = 0;
